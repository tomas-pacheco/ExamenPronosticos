...
# Examen final
# Integrantes: Kleiman, Pacheco y Riquelme
# Fecha de entrega: 30 de junio de 2020


# Para resolver el examen final utilizamos dos enfoques distintos vistos en clase: el
# estudio de eventos y distintos modelos para pronosticar. Es por eso que este script
# estará dividido en dos partes. En la primera de ellas presentaremos el código que utilizamos
# para realizar los pronósticos, mientras que en la segunda se encuentran los comandos
# que replican los estudios de eventos. Este código no fue el único que usamos para realizar
# el examen, ya tuvimos que construir la base de datos con data de distintas fuentes. 
#Para replicar el armado de la base, sugerimos visitar el repositorio de Github con el
# siguiente enlace: https://github.com/tomas-pacheco/ExamenPronosticos .

# Comenzamos seteando el directorio, que debe ser la carpeta en la que se encuentra
# la base de datos (de no querer definir un directorio, la base de datos se podrá
...
########                   Parte II: Estudio de eventos                ######## 

###############################################################################

# Volvemos a importar la base de datos y nos quedamos con las variables
# que nos interesan.
...
# Segundo evento. Intervención de Vicentin. 11 de junio 2020
